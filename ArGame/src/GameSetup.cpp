...
static const char* generalConfFile = "Data\\arGame.txt";
...
void GameSetup::init()
{
	...
	ConfigManager::getSingleton().getValueInt(&paddle1MarkerID, generalConfFile, "paddle1MarkerID");
	ConfigManager::getSingleton().getValueInt(&paddle2MarkerID, generalConfFile, "paddle2MarkerID");
	ConfigManager::getSingleton().getValueFloat(&ballSpeedupFactor, generalConfFile, "ballSpeedup");
